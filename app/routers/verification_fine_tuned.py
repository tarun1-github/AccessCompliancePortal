...
# ACCESS PORTAL ENGINEER MANAGEMENT - GENERATED BLOCK
...
def _restore_active_applications_for_engineer(
    db: Session,
    engineer_id: int
) -> int:
    ...
    # Supervisors manage the portal and do not
    # receive engineer application assignments.
...
def manage_engineer_create(
    ...
    # Generate initial password setup token
...
@router.post("/api/supervisor/engineers/{engineer_id}/reactivate")
